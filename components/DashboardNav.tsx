...
export default function DashboardNav({ onSignOut }: DashboardNavProps) {
  ...
  if(flags.chat_studio)items.splice(1,0,{href:'/dashboard/studio',label:'Chat Studio',icon:'◉'})
  if(flags.stream_tools)items.splice(flags.chat_studio?3:2,0,{href:'/dashboard/tools',label:'Stream Tools',icon:'✦'})
